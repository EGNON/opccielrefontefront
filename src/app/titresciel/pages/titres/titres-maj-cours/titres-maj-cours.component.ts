...
import {delay, forkJoin, fromEvent, of, Subject, Subscription} from "rxjs";
    ...
    const columns: any[] = [
      /*{
        title: 'DATE', data: 'dateCours', render: function (data, type, row) {
          ...
          return `<input name="dateCours" class="form-control form-control-sm" value="${moment(self.dateCours).format('DD/MM/YYYY')}"/>`;
        },
      },*/
      {
        title: 'SYMBOLE', data: 'symbolTitre', render: function (data:any, type:any, full:any) {
