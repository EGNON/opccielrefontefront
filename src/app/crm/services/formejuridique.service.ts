...
export class FormejuridiqueService extends ResourceService<Formejuridique> {
  constructor(private http: HttpClient) {
    super(http, Formejuridique, `${environment.apiUrl}/formejuridiques`);
    this.API_URL = `${environment.apiUrl}/formejuridiques`;
  }
  afficherTous(){
