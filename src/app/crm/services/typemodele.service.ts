...
export class TypemodeleService extends ResourceService<Typemodele> {
  constructor(private http: HttpClient) {
    super(http, Typemodele, `${environment.apiUrl}/typemodeles`);
    this.API_URL = `${environment.apiUrl}/typemodeles`;
  }
  afficherTous(){
