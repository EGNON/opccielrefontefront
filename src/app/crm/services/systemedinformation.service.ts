...
import {Systemedinformation} from "../models/systemedinformation.model";

@Injectable({ providedIn: 'root' })
export class SystemedinformationService extends ResourceService<Systemedinformation> {
  constructor(private http: HttpClient) {
    super(http, Systemedinformation, `${environment.apiUrl}/systemedinformations`);
    this.API_URL = `${environment.apiUrl}/systemedinformations`;
  }
  afficherTous(){
