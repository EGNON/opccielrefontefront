...
import { DeletePersonnephysiqueSanctionneeModalComponent } from '../../personnephysique-sanctionnee/delete-personnephysique-sanctionnee-modal/delete-personnephysique-sanctionnee-modal.component';

@Component({
    selector: 'app-personne-physique-juge-list',
    templateUrl: './personne-physique-juge-list.component.html',
    styleUrl: './personne-physique-juge-list.component.scss',
    standalone: false
})
export class PersonnePhysiqueJugeListComponent implements OnInit, OnDestroy, AfterViewInit{
  isLoading: boolean;
  ...
  afficherPersonnePhysiqueSanctionnee(){
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        const sb = this.personnePhysiqueService.getPersonneJuge(dataTablesParameters)
          .subscribe(resp => {
            callback(resp);
...
/* implements OnInit, OnDestroy, AfterViewInit{
  ...
  ngOnInit(): void {
    this.afficherPersonnePhysiqueJuge();
  }
  ...
  afficherPersonnePhysiqueJuge(){
    this.datatableConfig = {
      serverSide: true,
      ajax: (dataTablesParameters: any, callback) => {
        const sb = this.personnePhysiqueService.getPersonnes(dataTablesParameters,"juge")
          .subscribe(resp => {
            callback(resp);
            console.log("Personne=",resp)
          });
