...
@Component({
  selector: 'app-personne-morale-expose-list',
  templateUrl: './personne-morale-expose-list.component.html',
  styleUrl: './personne-morale-expose-list.component.scss'
})
export class PersonneMoraleExposeListComponent implements OnInit, OnDestroy, AfterViewInit{
  isLoading: boolean;
  ...
  ngOnInit(): void {
    this.afficherPersonneMoralePolitiquementExpose();
  }
  ...
  afficherPersonneMoralePolitiquementExpose(){
    this.datatableConfig = {
      serverSide: true,
      ajax: (dataTablesParameters: any, callback) => {
        const sb = this.personneMoraleService.getPersonnes(dataTablesParameters,"expose")
          .subscribe(resp => {
            callback(resp);
  ...
  supprimer(id: number) {
    const modalRef = this.modalService.open(DeletePersonneMoraleExposeModalComponent);
