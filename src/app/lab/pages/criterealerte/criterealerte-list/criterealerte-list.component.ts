...
export class CriterealerteListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    public entityService: CritereAlerteService,
  ...
  ngOnInit(): void {
    this.datatableConfig = {
      ...
      columns: [
        {
          title: 'Date', data: 'dateAlerte', render: function (data, type, row) {
            return moment(row.dateAlerte).format('DD/MM/YYYY');
          }
        }
        , {
        ...
        {
          title: 'Etat', data: 'etat', render: function (data, type, row) {
            return row.etat;
          }
        }
      ],
  ...
  renderActionColumn(): void {
    if (this.datatableConfig.columns) {
      ...
      actions.render = (data: any, type: any, full: any) => {
        ...
        const edit = `
                <li>
                    <a type="button" class="dropdown-item" data-action="edit" data-id="${full.idCritereAlerte}">Modifier</a>
                </li>`;
        const separator = `<li><hr class="dropdown-divider"></li>`;
        const delete1 = `<li>
                    <a type="button" class="dropdown-item" data-action="delete" data-id="${full.idCritereAlerte}">Supprimer</a>
                </li>`;
