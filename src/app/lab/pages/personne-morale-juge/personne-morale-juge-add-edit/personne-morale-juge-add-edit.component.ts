...
export class PersonneMoraleJugeAddEditComponent implements OnInit, OnDestroy, AfterViewInit{
  ...
  ngOnInit() {
    ...
    if(this.id==null)
    {
      this.pageInfo.updateTitle("Ajout de personne morale jugée par des mesures de gel des avoirs");
    }
    else
      this.pageInfo.updateTitle("Modification de personne morale jugée par des mesures de gel des avoirs");
