...
@Component({
    selector: 'app-verificationecriturechargeniveau2',
    templateUrl: './verificationecriturechargeniveau2.component.html',
    styleUrl: './verificationecriturechargeniveau2.component.scss',
    standalone: false
})
export class Verificationecriturechargeniveau2Component implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
  listeAvisForm: any
  typeOperation$:any;
  currentOpcvm: any;
  ...
  ngOnInit(): void {
    ...
    this.liste=false
    this.pageInfo.updateTitle("Vérification écritures charges niveau 2");
    this.dtOptions = {
      // dom: 'Bfrtip',
  ...
  verificationEcritureNiveau1De(){
    ...
    this.operationService.etape(10,
  ...
  verificationNiveau1() {
    ...
    this.operationService.afficherListeVerificationEritureNiveau2(param,"CHARGE").subscribe(
      (data)=>{
  ...
  apercu() {
    ...
    console.log(param)
    this.operationService.apercuVerificationEritureNiveau(param,2,"CHARGE").subscribe(
      (data)=>{
