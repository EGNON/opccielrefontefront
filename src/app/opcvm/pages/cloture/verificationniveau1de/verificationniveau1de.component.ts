...
@Component({
    selector: 'app-verificationniveau1de',
    templateUrl: './verificationniveau1de.component.html',
    styleUrl: './verificationniveau1de.component.scss',
    standalone: false
})
export class Verificationniveau1deComponent implements OnInit{
  currentSeance: any;
  downloading: boolean;
  submitted: boolean;
  ...
  this.operationService.verifierEtape(
    2,
    this.currentOpcvm?.idOpcvm,
    this.currentSeance?.idSeanceOpcvm.idSeance,
    false,
    false,
    1
  ).pipe(
    ...
    if (contentType === 'application/pdf') {
      ...
      a.href = fileURL;
      a.download = 'verification_niveau1_de.pdf';
      a.click();
  ...
  // verificationNiveau1De(){
  //   this.downloading=true
  //   this.operationService.verifierEtape(2,
  //     this.localStore.getData("currentOpcvm")?.idOpcvm,this.currentSeance?.idSeanceOpcvm.idSeance,false,false,1)
  //     .pipe(
  //       catchError((err) => {
