...
@Component({
    selector: 'app-verificationecriturechargeniveau1',
    templateUrl: './verificationecriturechargeniveau1.component.html',
    styleUrl: './verificationecriturechargeniveau1.component.scss',
    standalone: false
})
export class Verificationecriturechargeniveau1Component implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
  listeAvisForm: any
  typeOperation$:any;
  currentOpcvm: any;
  ...
  ngOnInit(): void {
    ...
    this.liste=false
    this.pageInfo.updateTitle("Vérification écritures charges niveau 1");
    this.dtOptions = {
      // dom: 'Bfrtip',
  ...
  validationEcritureNiveau1(){
    ...
    this.operationService.validationEcritureNiveau1(this.idOperation,
      this.authService.currentUserValue?.username,"CHARGE",null,this.currentOpcvm?.idOpcvm).subscribe(
      (data)=>{
