...
@Component({
  selector: 'app-tableauaffectationresultat',
  standalone: false,
  templateUrl: './tableauaffectationresultat.html',
  styleUrl: './tableauaffectationresultat.scss'
})
export class Tableauaffectationresultat implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
  listeAvisForm: any
    ...
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        if (prefix.toLowerCase() === "l") {
          //datedebut
          let nature: Natureoperation =new Natureoperation();
          nature.codeNatureOperation="DECL_RES_EXE_CLO"
          param = {
            ...param,
           codeExercice:this.form.value.exercice.codeExercice,
          natureOperation:nature};
          console.log(param);
          const sb = this.operationService.afficherListeOperationsResultat(param)
            .subscribe(resp => {
              callback(resp.data);
