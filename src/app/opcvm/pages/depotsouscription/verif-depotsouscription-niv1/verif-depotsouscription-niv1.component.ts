  ...
  afficherListe() {
    ...
    this.datatableConfig = {
      ...
      columns: [
        ...
        {
          title: 'Vérifié ?', data: "estVerifie1", render: function(data, type, row){
            return `<div class="form-check form-check-custom form-check-solid form-check-success form-switch">
                      <div class="form-check form-check-custom form-check-solid form-switch mb-2">
                        <input disabled="disabled" name="estVerifie1" type="checkbox" class="form-check-input"
                            value="true" checked>
                      </div>
                    </div>`;
          }
      ...
      createdRow: function (row, data, dataIndex) {
        ...
        const depotClone: any = {
          ...data,
          estVerifie1: true,
          dateVerification1: new Date(),
          userLoginVerificateur1: self.currentUser?.username,
          estVerifie2: false,
        };
  ...
  telecharger() {
    ...
    const sb = this.entityService.telechargerListeDepot(downloadRequest)
      ...
      .subscribe((response: any) => {
        ...
        const fileName = 'listVerif1Depot.pdf';
