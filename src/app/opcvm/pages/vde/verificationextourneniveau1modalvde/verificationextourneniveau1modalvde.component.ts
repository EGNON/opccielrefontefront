...
export class Verificationextourneniveau1modalvdeComponent implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.pageInfo.updateTitle("Vérification des écritures d'extourne des VDE Niveau 1");
    this.dtOptions = {
      // dom: 'Bfrtip',
  ...
  verificationNiveau1() {
    ...
    this.operationService.afficherListeVerificationEritureNiveau1(param,"DE").subscribe(
      (data)=>{
