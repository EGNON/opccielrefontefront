...
@Component({
  selector: 'app-balanceavantinventaire',
  standalone: false,
  templateUrl: './balanceavantinventaire.html',
  styleUrl: './balanceavantinventaire.scss'
})
export class Balanceavantinventaire implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
...
afficherExercice(){
    ...
    this.datatableConfig = {
      ...
      ajax: (dataTablesParameters: any, callback) => {
        ...
        if (prefix.toLowerCase() === "l") {
          ...
          console.log(param);
          const sb = this.libService.balanceAvantInventaire(param)
            .subscribe(resp => {
  ...
  exportExcel() {
    ...
    this.libService.balanceAvantInventaireListe(param).subscribe(
      (data)=>{
  ...
  telecharger() {
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.balanceAvantInventaireEtat(param)
      .pipe(
        catchError((err) => {
