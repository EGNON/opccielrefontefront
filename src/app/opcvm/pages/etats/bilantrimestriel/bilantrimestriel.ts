...
@Component({
  selector: 'app-bilantrimestriel',
  standalone: false,
  templateUrl: './bilantrimestriel.html',
  styleUrl: './bilantrimestriel.scss'
})
export class Bilantrimestriel implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
    ...
    const sb = this.libService.etatfinanciertrimestrielbilantrimestrielEtat(param)
      .pipe(
       ...
       .subscribe((blob) => {
        ...
        a.href = url;
        a.download = 'bilan_trimestriel.pdf';
        a.click();
      });
    ...
    const sb = this.libService.noterevenusportefeuilletitremonetaires(param)
      .pipe(
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'notes_reveneus_portefeuille_titre_trimestriel.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
