...
@Component({
  selector: 'app-declarartion-commission-actif',
  standalone: false,
  templateUrl: './declarartion-commission-actif.html',
  styleUrl: './declarartion-commission-actif.scss'
})
export class DeclarartionCommissionActif implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
...
afficherExercice(){
  ...
  //   }
    ...
    this.dateDebut = new Date(this.annee, 0, 1);   // mois = 0 → Janvier
