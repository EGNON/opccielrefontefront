...
@Component({
  selector: 'app-bilanannuelf1',
  standalone: false,
  templateUrl: './bilanannuelf1.html',
  styleUrl: './bilanannuelf1.scss'
})
export class Bilanannuelf1 implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
...
afficherExercice(){
  ...
  telecharger(){
    switch (this.libelle.toLowerCase()) {
      case 'bilanannuelf1':
        this.bilanAnnuelF1();
        break;
      case 'resultatannuelf1':
        this.resultatAnnuelF1();
        break;
      case 'etatvariationactifnetannuelf1':
        this.etatvariationactifnetannuelf1();
        break;
      case 'notesrevenusportefeuilletitreannuelf1':
        this.notesrevenusportefeuilletitreannuelf1();
        break;
      case 'notesrevenusplacementmonetaireannuelf1':
        this.notesrevenusplacementmonetaireannuelf1();
        break;
      case 'notessommesdistribuablesannuelf1':
        this.notessommesdistribuablesannuelf1();
        break;
      case 'donneesratiosannuelf1':
        this.donneesratiosannuelf1();
        break;
  ...
  bilanAnnuelF1() {
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.bilanAnnuelF1Etat(param)
      .pipe(
        catchError((err) => {
       ...
       .subscribe((blob) => {
        ...
        a.href = url;
        a.download = 'bilan_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  notessommesdistribuablesannuelf1() {
    if(this.form.value.exercice==null){
      alert("Veuillez choisir un exercice.")
      return;
    }
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.notessommesdistribuablesannuelf1Etat(param)
      .pipe(
        catchError((err) => {
          this.downloading = false;
          return of(err.message);
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'notes_sommes_distribuables_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  donneesratiosannuelf1() {
    if(this.form.value.exercice==null){
      alert("Veuillez choisir un exercice.")
      return;
    }
    ...
    const sb = this.libService.donneesratiosannuelf1Etat(param)
      .pipe(
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'donnees_actions_ratios_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  ...
  notesrevenusportefeuilletitreannuelf1() {
    if(this.form.value.exercice==null){
      alert("Veuillez choisir un exercice.")
      return;
    }
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.notesrevenusportefeuilletitreannuelf1Etat(param)
      .pipe(
        catchError((err) => {
          this.downloading = false;
          return of(err.message);
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'notes_revenus_portefeuille_titre_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  notesrevenusplacementmonetaireannuelf1() {
    if(this.form.value.exercice==null){
      alert("Veuillez choisir un exercice.")
      return;
    }
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.notesrevenusplacementmonetaireannuelf1Etat(param)
      .pipe(
        catchError((err) => {
          this.downloading = false;
          return of(err.message);
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'notes_revenus_placements_monetaires_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  resultatAnnuelF1() {
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.resultatAnnuelF1Etat(param)
      .pipe(
        catchError((err) => {
          this.downloading = false;
          return of(err.message);
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'resultat_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
  etatvariationactifnetannuelf1() {
    if(this.form.value.exercice==null){
      alert("Veuillez choisir un exercice.")
      return;
    }
    ...
    //.subscribe
    console.log(param);
    const sb = this.libService.etatvariationactifnetannuelf1Etat(param)
      .pipe(
        catchError((err) => {
          this.downloading = false;
          return of(err.message);
       ...
       .subscribe((blob) => {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'etat_variation_actif_net_Annuel_F1.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
