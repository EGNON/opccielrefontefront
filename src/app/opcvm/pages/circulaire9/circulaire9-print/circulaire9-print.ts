...
@Component({
  selector: 'app-circulaire9-print',
  standalone: false,
  templateUrl: './circulaire9-print.html',
  styleUrl: './circulaire9-print.scss'
})
export class Circulaire9Print implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
...
afficherJournal(){
  ...
  telecharger() {
    ...
    //.subscribe
    const sb = this.libService.circulaire9(param)
      .pipe(
        catchError((err) => {
