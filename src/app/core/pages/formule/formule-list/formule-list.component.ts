...
@Component({
  ...
  styleUrl: './formule-list.component.scss'
})
export class FormuleListComponent implements OnInit, OnDestroy, AfterViewInit {
  isLoading: boolean;
  ...
  constructor(
    ...
    public entityService: FormuleService,
  ...
  ngOnInit(): void {
    this.datatableConfig = {
      ...
      columns: [
        {
          title: 'Libellé', data: 'libelleFormule', render: function (data, type, row) {
            return row.libelleFormule;
          }
        },
        {
          title: 'Type formule', data: 'codeTypeFormule', render: function (data, type, row) {
            return row.typeFormule.codeTypeFormule;
          }
        },
      ],
  ...
  renderOperationColumn(): void {
    if (this.datatableConfig.columns) {
      ...
      Operations.render = (data: any, type: any, full: any) => {
        ...
        const edit = `
                <li>
                    <a type="button" class="dropdown-item" data-action="edit" data-id="${full.idFormule}">Modifier</a>
                </li>`;
        const separator = `<li><hr class="dropdown-divider"></li>`;
        const delete1 = `<li>
                    <a type="button" class="dropdown-item" data-action="delete" data-id="${full.idFormule}">Supprimer</a>
                </li>`;
  ...
  supprimer(id: any) {
    const modalRef = this.modalService.open(DeleteFormuleModalComponent);
