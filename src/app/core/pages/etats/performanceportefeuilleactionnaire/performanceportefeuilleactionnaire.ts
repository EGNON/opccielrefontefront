...
@Component({
  selector: 'app-performanceportefeuilleactionnaire',
  standalone: false,
  templateUrl: './performanceportefeuilleactionnaire.html',
  styleUrl: './performanceportefeuilleactionnaire.scss'
})
// eslint-disable-next-line @angular-eslint/component-class-suffix
export class Performanceportefeuilleactionnaire implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
  ...
  telecharger() {
    ...
    //.subscribe
    const sb = this.libService.performancePortefeuilleActionnaire(param)
      .pipe(
        catchError((err) => {
     ...
     .subscribe((blob) => {
        ...
        a.href = url;
        a.download = 'performance_portefeuille_actionnaire.pdf';
        a.click();
      });
    this.subscriptions.push(sb);
  }
