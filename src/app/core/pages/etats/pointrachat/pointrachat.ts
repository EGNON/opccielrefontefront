...
@Component({
  selector: 'app-pointrachat',
  standalone: false,
  templateUrl: './pointrachat.html',
  styleUrl: './pointrachat.scss'
})
export class Pointrachat implements OnInit, AfterViewInit, AfterContentInit, OnDestroy {
  form: FormGroup;
