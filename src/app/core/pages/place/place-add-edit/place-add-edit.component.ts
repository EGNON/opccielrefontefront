...
export class PlaceAddEditComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.entityForm = this.fb.group(
      {
        id: [null],
        libellePlace: [null, Validators.required],
        codePlace: [null, Validators.required],
      }
    );
    // this.afficherCategorie();
    if (this.id) {
      console.log(this.id)
      this.pageInfo.updateTitle("Modification de place boursière")
      ...
      this.pageInfo.updateTitle("Ajout de place boursière")
    }
  }
  loadFormValues(entity: any)
  {
    this.entity = entity;
    this.entityForm.patchValue({libellePlace: entity.libellePlace});
    this.entityForm.patchValue({codePlace: entity.codePlace});
  }
