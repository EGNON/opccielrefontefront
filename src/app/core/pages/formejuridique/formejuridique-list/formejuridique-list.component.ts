...
export class FormejuridiqueListComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    public entityService: FormejuridiqueService,
  ...
  ngOnInit(): void {
    this.datatableConfig = {
      ...
      columns: [
        {
          title: 'Code', data: 'codeFormeJuridique', render: function (data, type, row) {
            return row.codeFormeJuridique;
          }
        },
        {
          title: 'Libellé', data: 'libelleFormeJuridique', render: function (data, type, row) {
            return row.libelleFormeJuridique;
          }
        },
      ],
  ...
  renderActionColumn(): void {
    if (this.datatableConfig.columns) {
      ...
      actions.render = (data: any, type: any, full: any) => {
        ...
        const show = `
                <li>
                    <a type="button" class="dropdown-item" data-action="view" data-id="${full.codeFormeJuridique}">Afficher</a>
                </li>`;
        const edit = `
                <li>
  ...
  supprimer(id: any) {
    const modalRef = this.modalService.open(DeleteFormejuridiqueModalComponent);
