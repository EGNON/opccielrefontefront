...
import {Typecompte} from "../../models/revuecompte/typecompte.model";

@Injectable({ providedIn: 'root' })
export class TypecompteService extends ResourceService<Typecompte> {
  constructor(private http: HttpClient) {
    super(http, Typecompte, `${environment.apiUrl}/typecomptes`);
    this.API_URL = `${environment.apiUrl}/typecomptes`;
  }
  afficherTous(){
